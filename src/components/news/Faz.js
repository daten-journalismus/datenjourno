      ...
      <div className="projects-grid">
          ...
          <Card shadow={5} style={{minWidth:"450",margin:"auto"}}>
            ...
            <CardText>
              <table>
                ...
                <tr>
                  ...
                  <td><a href="https://www.alexa.com/siteinfo/faz.net" target="_blank" rel="noopener noreferrer">110</a></td>
                </tr>
              </table>
            </CardText>
            <CardActions border>
            ...
            <CardMenu style={{color:"#fff"}}>
              <a href="https://www.faz.net/aktuell/politik/" target="_blank" rel="noopener noreferrer">
                <IconButton name="launch" />
              </a>
              {/*  */}
              <a href="https://en.wikipedia.org/wiki/Frankfurter_Allgemeine_Zeitung" target="_blank" rel="noopener noreferrer">
