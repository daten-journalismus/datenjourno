...
export class YahooNews extends Component {
      ...
      <div className="projects-grid">
          ...
          <Card shadow={5} style={{width:"450",margin:"auto"}}>
            ...
            <CardText>
              ...
              <table>
                ...
                <tr>
                  ...
                  <td><a href="https://www.alexa.com/topsites/countries/DE" target="_blank" rel="noopener noreferrer">17</a> <span style={{fontSize:"9pt"}}>(yahoo.com)</span></td>
                </tr>
              </table>
            </CardText>
            <CardActions border>
            ...
            <CardMenu style={{color:"#fff"}}>
              <a href="https://de.nachrichten.yahoo.com/politik" target="_blank" rel="noopener noreferrer">
                <IconButton name="launch" />
              </a>
              {/*  */}
              <a href="https://en.wikipedia.org/wiki/Bing_(search_engine)#Yahoo#Angebote" target="_blank" rel="noopener noreferrer">
