...
export class Bild extends Component {
            ...
            <CardText>
              <table>
                ...
                <tr>
                  ...
                  <td><a href="https://www.alexa.com/siteinfo/bild.de" target="_blank" rel="noopener noreferrer">23</a></td>
                </tr>
              </table>
            </CardText>
            <CardActions border>
              ...
              <Button colored disabled >
                <i className="fa fa-twitter-square" style={{fontSize:"1.5em",verticalAlign:"top",paddingTop:"5px"}}></i>
              </Button>
            </CardActions>
            <CardMenu style={{color:"#fff"}}>
              <a href="https://www.bild.de/politik/" target="_blank" rel="noopener noreferrer">
                <IconButton name="launch" />
              </a>
              {/*  */}
              <a href="https://de.wikipedia.org/wiki/Bild_(Zeitung)" target="_blank" rel="noopener noreferrer">
