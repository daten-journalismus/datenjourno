...
export class Presse extends Component {
  ...
  cardStyle= ()=> {
    return({
      ...
      background:"url('img/presse.png') Center / contain no-repeat"
    })    
  }
      ...
      <div className="projects-grid">
          ...
          <Card shadow={5} style={{width:"450",margin:"auto"}}>
            ...
            <CardText>
              <table>
                ...
                <tr>
                  ...
                  <td><a href="https://www.alexa.com/siteinfo/diepresse.com" target="_blank" rel="noopener noreferrer">88</a></td>
                </tr>
              </table>
            </CardText>
            <CardActions border>
            ...
            <CardMenu style={{color:"#fff"}}>
              <a href="https://www.diepresse.com/innenpolitik" target="_blank" rel="noopener noreferrer">
                <IconButton name="launch" />
              </a>
              {/*  */}
              <a href="https://de.wikipedia.org/wiki/Die_Presse" target="_blank" rel="noopener noreferrer">
