...
export class Hb extends Component {
  ...
  cardStyle= ()=> {
    return({
      ...
      background:"url('img/hb.png') Center / contain no-repeat"
    })    
  }
      ...
      <div className="projects-grid">
          ...
          <Card shadow={5} style={{width:"450",margin:"auto"}}>
            ...
            <CardText>
              <table>
                ...
                <tr>
                  ...
                  <td><a href="https://www.alexa.com/siteinfo/handelsblatt.com" target="_blank" rel="noopener noreferrer">284</a></td>
                </tr>
              </table>
            </CardText>
            <CardActions border>
            ...
            <CardMenu style={{color:"#fff"}}>
              <a href="https://www.handelsblatt.com/politik/" target="_blank" rel="noopener noreferrer">
                <IconButton name="launch" />
              </a>
              {/*  */}
              <a href="https://de.wikipedia.org/wiki/Handelsblatt" target="_blank" rel="noopener noreferrer">
